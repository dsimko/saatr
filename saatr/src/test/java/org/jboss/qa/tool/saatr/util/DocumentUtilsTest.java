...
//
// import org.jboss.qa.tool.saatr.entity.jaxb.config.ConfigFile;
// import org.jboss.qa.tool.saatr.entity.jaxb.config.Field;
...
// File xml = new
// File(DocumentUtilsTest.class.getResource("config.xml").getPath());
// Assert.assertNotNull(xml);
// ConfigFile document = IOUtils.unmarshal(xml);
// Assert.assertEquals("CrashRecFailed", document.getName());
// Assert.assertEquals("org.jboss.qa.tool.saatr.jenkins.miner.crashrec.CrashRecJenkinsMiner",
// document.getJenkinsMinerClass());
...
// ConfigFile document = new ConfigFile();
...
// assertThat(document.getFields(), is(Arrays.asList(new Field("field1",
// "value1"), new Field("field2", "value2"))));
// }
//
